                ...
                <div className="container  py-5">
                    <div className="row">
                        ...
                        <Link to="/">    <img className="footer-logo-size img-fluid" src={logo} alt="" /></Link>
                            <div className="pt-4">
                                <p> <FontAwesomeIcon icon={faEnvelopeSquare}></FontAwesomeIcon> Official: lca@gmail.com <br />
                                <FontAwesomeIcon icon={faPhoneSquareAlt}></FontAwesomeIcon> Helpline: 0123456789 <br /> (Available: 09:00am to 11:00pm)</p>
                            </div>
                            <div >
                                <span className="pr-2">
