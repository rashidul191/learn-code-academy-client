                ...
                <div className="container  py-5">
                    <div className="row">
                        ...
                        <Link to="/">    <img className="footer-logo-size img-fluid" src={logo} alt="" /></Link>
                            ...
                            <div >
                                <span className="pr-2">
                                    <Link target="_blank" href="https://www.facebook.com/groups/learncodeacademy">
                                ...
                                <span className="p-2">
                                    <Link target="_blank" href="https://www.linkedin.com/in/rashidul191/">
                                ...
                                <span className="p-2">
                                    <Link target="_blank" href="https://twitter.com/Rashidul191">
                                ...
                                <span className="pl-2">
                                    <Link target="_blank" href="https://www.instagram.com/rashidul191.r/">
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-6 pb-3">
                            <ul class="navbar-nav ">
                                <li class="nav-item active">
                                    <Link class="nav-link mr-2" to="/about-us">About Us</Link>
                                </li>
                                <li class="nav-item">
